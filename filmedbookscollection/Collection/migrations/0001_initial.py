    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tagy', models.ManyToManyField(to='Collection.tag')),
                ('zanr', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Collection.zanr', verbose_name='Žánr')),
            ],
            options={
                'verbose_name': 'Film',
